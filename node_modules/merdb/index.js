...
var db = new Database(__dirname+'/db/mer.db');
...
exports.namMer=function(name){
var stm=db.prepare('select sku from mer where name=?');
var row=stm.get(name);
return row;
};

exports.catMer=function(cat){
var stm=db.prepare('select * from mer where cat=?');
try{var row=stm.all(cat);}
...
// sea
exports.allNam=function(){
var stm=db.prepare('select name from mer order by sku desc')
var row=stm.all();
return row;
};

exports.allSku=function(){
var stm=db.prepare('select sku from mer order by sku desc')
var row=stm.all();
return row;
};

exports.seaLik=function(name){
var stm=db.prepare('select * from mer where name like(?)');
var row=stm.get(name);
return row;
};
...
exports.allEit=function(){
var stm=db.prepare('select *,rowid from eit order by sku desc');
var row=stm.all();
return row;
};

exports.skuEit=function(sku){
var stm=db.prepare('select * from eit where sku=?');
var row=stm.get(sku);
return row;
};

exports.namEit=function(name){
var stm=db.prepare('select sku from eit where name=?');
var row=stm.get(name);
return row;
};

exports.catEit=function(cat){
var stm=db.prepare('select * from eit where cat=?');
try{var row=stm.all(cat);}
catch(err){console.log(err);}
return row;
};
...
exports.allJit=function(){
var stm=db.prepare('select *,rowid from jit order by sku desc');
var row=stm.all();
return row;
};

exports.skuJit=function(sku){
var stm=db.prepare('select * from jit where sku=?');
var row=stm.get(sku);
return row;
};

exports.namJit=function(name){
var stm=db.prepare('select sku from jit where name=?');
var row=stm.get(name);
return row;
};

exports.catJit=function(cat){
var stm=db.prepare('select * from jit where cat=?');
try{var row=stm.all(cat);}
catch(err){console.log(err);}
return row;
}
